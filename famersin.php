...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO farmer (name, lname, product, quantity, cost, contact) VALUES ('$name','$lname', '$product', '$quantity', '$cost','$contact')"; // Include the name and contact in the query
                ...
                <div class=" form login" style="background-color:#ccc;">
                    <div class="form-content">
                        ...
                        <p style="font-size: 15px;">
                            <strong style="font-size: 15px;">NB:</strong> the payment will be done once the product has been delivered successfully! we will notify to you once that happens.
                        </p>
